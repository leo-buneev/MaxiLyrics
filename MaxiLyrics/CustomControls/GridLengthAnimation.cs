...
///<summary>
///Contains several enhancements or modifications of standard WPF classes,
///mainly controls.
///</summary>
namespace MaxiLyrics.CustomControls
{
    /// <summary>
    ...
    public class GridLengthAnimation : AnimationTimeline
    {
        ...
        /// <summary>
        /// Wrapper for the From depenendency property
        /// </summary>
        ...
        /// <returns>Returns the new grid length to set. Uses "Star" GridUnitType anyway.</returns>
            ...
            object defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            if (from.IsAuto)
            {
                from = ((GridLength)defaultDestinationValue);
            }
